    ...
    <div class="flex h-[700px] w-full">
        ...
        <div class="w-full flex flex-col items-center justify-center">
            ...
            <form class="md:w-96 w-80 flex flex-col items-center justify-center">
                ...
                <div
                    class="flex items-center w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2 mt-5">
                ...
                <p class="text-gray-500/90 text-sm mt-4">Don’t have an account? <router-link to="/login"
                        class="text-indigo-400 hover:underline">Sign up</router-link></p>
            </form>
        </div>
    </div>
</template>
